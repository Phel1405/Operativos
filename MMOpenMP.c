...
void InicioMuestra(){
	// Utiliza la hora del dia para inicializar la muestra
...
void impMatrix(size_t *matrix, int D){
	...
	// Revisa si el tamaño de la matrices es menor a 9 para poder imprimirla por consola
	if(D < 9){
...
void multiMatrix(size_t *mA, size_t *mB, size_t *mC, int D){
	...
	//Utiliza OpenMP para realizar paralelismo con la cantidad máxima de hilos
